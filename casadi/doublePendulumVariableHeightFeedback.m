...
weights.torques = 1/N;
weights.simplifiedControl = 100/N;
weights.K = 0.01/N;
weights.computedDesired = 0.01/N;
weights.K_diff = 0.1/N;
weights.computedDesiredDiff = 0.01/N;

tic
[xsol, usol, a_sol, t_sol, K_sol, x_des_sol] = ...
...
plotOptiSolutionForDoublePendulumFeedback(xsol, usol, a_sol,...
                                          t_sol, K_sol, x_des_sol);
